...
<div className="App">
  ...
  <div class="menu">
    <div class="container">
      <div class="row">
        <div class="col col-12" id="text3">
          View Our Menu
        </div>

        <div class="col col-12" id="text4">Sample text. Click to select the Text Element. Image from <span
        ...
        <div class=" menuimg">
          ...
          <div>
            <img src="https://assets.nicepagecdn.com/11a8ddce/4267640/images/delicious-pizza-isolated-white.jpg" alt=""
              id="menupic" />
            <br />
            <h5>HOT PIZZA</h5><br />
            <button><a href="https://nicepage.one/">Read More</a></button>
          </div>

          <div>
            <img
              src="https://assets.nicepagecdn.com/11a8ddce/4267640/images/high-angle-shot-vegetable-salad-white-bowl.jpg"
              alt="" id="menupic" />
            <br />
            <h5>SALADS</h5><br />
            <button><a href="https://nicepage.one/">Read More</a></button>
        ...
        <div class=" menuimg">
          ...
          <div>
            <img src="https://assets.nicepagecdn.com/11a8ddce/4267640/images/pexels-photo-3681641.jpeg" alt=""
              id="menupic" />
            <br />
            <h5>DESSERT</h5><br />
            <button><a href="https://nicepage.one/">Read More</a></button>
          ...
          <div>
            <img src="https://assets.nicepagecdn.com/11a8ddce/4267640/images/pexels-photo-3939602.jpeg" alt=""
              id="menupic" />
            <br />
            <h5>DRINKS</h5><br />
            <button><a href="https://nicepage.one/">Read More</a></button>
  ...
  <div class="footer2">
    <span> <a href="https://nicepage.com/website-templates">Website Templates</a></span> created with <span><a
        href="https://nicepage.com/website-templates">Website Builder Software</a></span>.
  </div>
